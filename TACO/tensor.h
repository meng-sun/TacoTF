...
//NEW CODE ADDED HERE
  std::vector<taco::ir::Stmt> get_lowers(bool assembleWhileCompute=false);
  std::string functionize(std::vector<taco::ir::Stmt> statements);
  
  void apply_funcs(std::string path, taco::ir::Stmt * assembleFunc, taco::ir::Stmt * computeFunc);
//END OF CODE HERE
